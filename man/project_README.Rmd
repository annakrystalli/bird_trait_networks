...
Evaluation of trait pair data avalaibility (full data). [Network_Data_Availability.Rmd generating script](https://github.com/annakrystalli/bird_trait_networks/blob/master/man/Network_Data_Availability.Rmd) in `man/` folder in repo.
