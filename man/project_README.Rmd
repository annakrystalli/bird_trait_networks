...
- #### [**`Network_Data_Availability`**](http://annakrystalli.github.io/bird_trait_networks/Network_Data_Availability.nb.html): 
Evaluation of trait pair data avalaibility (full data). [Network_Data_Availability.Rmd generating script](https://github.com/annakrystalli/bird_trait_networks/blob/master/reports/results/Network_Data_Availability.Rmd) in `reports/results/` folder in repo.
...
Evaluation of trait pair data avalaibility (100spp data). [Network_Data_Availability 100spp.Rmd generating script](https://github.com/annakrystalli/bird_trait_networks/blob/master/reports/results/Network_Data_Availability_100spp.Rmd) in `reports/results/` folder in repo.
